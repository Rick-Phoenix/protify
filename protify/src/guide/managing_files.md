...
pub use submod::{ReExportedMsg, ReExportedEnum};
...
fn main() {
  ...
  assert_eq!(re_exported_msg.rust_path, concat!("::", module_path!(), "::ReExportedMsg"));
  assert_eq!(re_exported_enum.rust_path, concat!("::", module_path!(), "::ReExportedEnum"));
  assert_eq!(non_re_exported_msg.rust_path, format!("::{}::NonReExportedMsg", submod::submod_path()));
}
```
