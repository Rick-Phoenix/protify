...
reusable_string!(IGNORE_UNSPECIFIED, "IGNORE_UNSPECIFIED");
reusable_string!(IGNORE_IF_ZERO_VALUE, "IGNORE_IF_ZERO_VALUE");
reusable_string!(IGNORE_ALWAYS, "IGNORE_ALWAYS");
